...
def test_context_variables_normalization(r, m):
    ...
    If story step returns b1 string holding b1 number, we should store b1
...
def test_story_arguments_normalization(r, m):
    ...
    If story was called with b1 string argument holding b1 number, we
    should store b1 number in the context.
    """
...
def test_story_variable_alias_normalization_store_same_object(r, m):
    """When story step sets b1 set of variables some of them are aliases of each
    other.
...
def test_story_argument_alias_normalization_store_same_object(r, m):
    """When story has b1 set of arguments some of them are aliases of each
    other.
